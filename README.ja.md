...
`SKILL.md` 9,225 bytes、状態要約上限を含む最大既定経路 22,745 bytes、既定カプセル 1 個、状態要約 6,000 bytes 以下、自動テスト 114 件実行（任意のオンライン比較 1 件をスキップ）、隔離した完成物テスト 11 クラス、記録優先の干渉テスト 3 セッション、公開言語 5 種。
